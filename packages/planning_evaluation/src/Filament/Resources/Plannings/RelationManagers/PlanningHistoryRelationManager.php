...
class PlanningHistoryRelationManager extends RelationManager
{
        ...
        return $table
            ...
            ->actions([
                ViewAction::make()
                    ...
                    ->modalHeading(trans('packages.planning_evaluation::planning.history.modal_heading'))
                    ->modalContent(fn ($record) => view('planning-evaluation::filament.resources.planning-history-view', ['snapshot' => $record->snapshot]))
                    ->modalWidth('7xl')
                    ->slideOver(),
            ])
            ->bulkActions([
