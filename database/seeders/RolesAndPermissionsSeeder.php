...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $managerPermissions = [
            ...
            'schedules.destroy',
            'schedules.view_all',
            'schedule_exceptions.index',
            'schedule_exceptions.create',
            'schedule_exceptions.edit',
            'schedule_exceptions.show',
            'schedule_exceptions.destroy',
            'schedule_exceptions.approve',
            // User Management
            'users.index',
            'users.create',
            'users.edit',
